...
(function () {
  ...
  const DICT = {
    ...
    "trk.lead": { de: "Logge Sätze, Gewichte und Wiederholungen — mit Auto-Vorschlag aus deinem letzten Training, PRs, geschätztem 1RM und Fortschritts-Charts. Dazu Cardio, Schlaf und Körpermaße. Alles lokal auf deinem Gerät, ohne Konto.",
                  en: "Log sets, weights and reps — with auto-fill from your last session, PRs, estimated 1RM and progress charts. Plus cardio, sleep and body metrics. All stored locally on your device, no account." },
